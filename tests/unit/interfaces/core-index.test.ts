...
describe('interfaces/core/beta/index', () => {
  describe('exports', () => {
    it('should export AsyncProxy', () => {
      expect(AsyncProxy).to.be.a('function');
    });

    it('should export RegisteringProxy', () => {
      expect(RegisteringProxy).to.be.a('function');
    });

    it('should export EventProxy', () => {
      expect(EventProxy).to.be.a('function');
    });

    it('should export internal namespace', () => {
      expect(internal).to.be.an('object');
    });

    it('should export GetResponsibleModule', () => {
      expect(GetResponsibleModule).to.be.a('function');
    });

    it('should export GetMetadata', () => {
      expect(GetMetadata).to.be.a('function');
    });

    it('should export InterfaceFunction', () => {
      expect(InterfaceFunction).to.be.a('function');
    });

    it('should export ImplementInterface', () => {
      expect(ImplementInterface).to.be.a('function');
    });

    it('should export GetInterfaceInstances', () => {
      expect(GetInterfaceInstances).to.be.a('function');
    });

    it('should export GetInterfaceInstance', () => {
      expect(GetInterfaceInstance).to.be.a('function');
    });
  });

  describe('internal namespace', () => {
    it('should have moduleByFolder array', () => {
      expect(internal.moduleByFolder).to.be.an('array');
    });

    it('should have knownAsync map', () => {
      expect(internal.knownAsync).to.be.instanceof(Map);
    });

    it('should have knownRegisters map', () => {
      expect(internal.knownRegisters).to.be.instanceof(Map);
    });

    it('should have knownEvents array', () => {
      expect(internal.knownEvents).to.be.an('array');
    });

    it('should have interfaceConnections object', () => {
      expect(internal.interfaceConnections).to.be.an('object');
    });

    it('should have addAsyncProxy function', () => {
      expect(internal.addAsyncProxy).to.be.a('function');
    });

    it('should have addRegisteringProxy function', () => {
      expect(internal.addRegisteringProxy).to.be.a('function');
    });
  });
